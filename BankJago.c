...
void akunDefault(){
    ...
    char file[]= "name_pass.csv";
    f = fopen(file, "a+");
    rek = fopen("data_rek.csv", "a+");
...
void eAkun(){
    ...
    fp = fopen(file, "r");
    fpsementara = fopen("fpsementara.txt", "a+");
...
void riwayat(long norek, int jenis, long jumlahTx, long jumlahSaldo){
    ...
    int mem = strlen(convert) + strlen(format);
    char file[mem];
    char fileLog[] = "riwayat_transaksi.csv";
...
void editRek(){
    ...
    char file[] = "data_rek.csv";
    fp = fopen(file, "r");
    fpsementara = fopen("fpsementara.csv", "a+");
...
void transfer(){
    ...
    if(statusTf == 1){
        ...
        fpsementara = fopen("fpsementara.csv", "r");
        fpsementara2 = fopen("fpsementara2.csv", "a+");
